...
- [Table content of Javascript Basic](#table-content-of-javascript-basic)
...
- [III. String and String Methods](#iii-string-and-string-methods)
  ...
  - [- end >= length of the string, return an extracted string from start to end of the string](#--end--length-of-the-string-return-an-extracted-string-from-start-to-end-of-the-string)
  - [III.6 substring](#iii6-substring)
  - [- end >= length of the string, return an extracted string from start to end of the string](#--end--length-of-the-string-return-an-extracted-string-from-start-to-end-of-the-string-1)
  - [III.7 substr](#iii7-substr)
  - [- length <= 0, return empty string <br/>](#--length--0-return-empty-string-)
  - [III.8 replace](#iii8-replace)
  - [| 3 |   \|   | Multiple replacements | var str = "Mr Blue has a blue house and a blue car"; | str.replace(/blue\|house\|car/gi, function (x) { return x.toUpperCase();});  |Mr BLUE has a BLUE HOUSE and a BLUE CAR.|](#-3--------multiple-replacements--var-str--mr-blue-has-a-blue-house-and-a-blue-car--strreplacebluehousecargi-function-x--return-xtouppercase--mr-blue-has-a-blue-house-and-a-blue-car)
  - [III.9 charAt](#iii9-charat)
  - [- If index > length and [], then return undefined](#--if-index--length-and--then-return-undefined)
  ...
  - ['s','S','t','T','u','U','v','V','w','W','x','X','y','Y','z','Z'](#ssttuuvvwwxxyyzz)
